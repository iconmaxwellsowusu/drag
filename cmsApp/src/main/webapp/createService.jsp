...
String preacher=request.getParameter("preacher");
...
PreparedStatement pst = con.prepareStatement("insert into service(date,assembly,service,ses,preacher,sermon,recordedBy) values(?,?,?,?,?,?,?)");

pst.setString(1, date);
pst.setString(2, assembly);
pst.setString(3, service);
pst.setString(4, ses);
pst.setString(5, preacher);
pst.setString(6, sermon);
pst.setString(7, recordedBy);
                                        ...
                                        <div class="col-sm-12">
                                            <div class="card">
                                               ...
                                               <!-- ----------------------------- Calculated Values ----------------------------------------- --> 
                                                                      ...
                                                                      <div align="center"><h6 style="margin-top:15px">ADD A SERVICE</h6></div>
                                                                      <hr style="border: 1px solid orange; margin-bottom:0px;">
                                                                  ...
                                                                  <form method="post" action="#">
                                                                        <div class="form-group row  container justify-content-center" >
                                                                            <div class="col-sm-3">
                                                                             ...
                                                                             <div class="col-sm-3">
                                                                             <label>Service Name</label> <!-- Drop down with Check Boxes -->
                                                                             <div class="input-group">
                                                                       ...
                                                                       <div class="form-group row  container justify-content-center" >
                                                                           ...
                                                                           <div class="col-sm-3">
                                                                             <label>Session</label> <!-- Drop down with Check Boxes -->
                                                                             <div class="input-group">
                                                                        ...
                                                                        <div class="form-group row  container justify-content-center" >
                                                                           ...
                                                                           <div class="col-sm-3">
                                                                            ...
                                                                            <label> Recorded By</label>
                                                                                <input type="text" class="form-control" name="recordedBy" >
                                                                            </div>
                                                                        </div>
                                              ...
                                              <div class="card-block table-border-style">
                                                <div class="table-responsive">
                                                    <table class="table table-hover">
                                                        ...
                                                        <td><%=rs.getString("assembly") %></td>
                                                        <td><%=rs.getString("service") %></td>
                                                        <td><%=rs.getString("ses") %></td>
                                                        <td><%=rs.getString("preacher") %></td>
                                                         <td>
                                                                 ...
                                                                 <a href="recordAttendance.jsp?id=<%=rs.getString("id")%>"><button title="Record Attendance" ><i class="ti-plus" style="color:black; cursor:pointer; padding:5px;"></i></button></a>
                                                                <a href="vAttendance.jsp?id=<%=rs.getString("id")%>"><button title="Veiw Attendance" ><i class="ti-eye" style="color:green; cursor:pointer; padding:5px;"></i></button></a>
