...
ResultSet rs;
                   if(request.getParameter("chil")!=null){ 
					...
					String currentx=request.getParameter("current");
				    ...
				    String sql = "SELECT currentx FROM demography WHERE descrip ='"+description+"' ORDER BY ID LIMIT 1";
					...
					if(description.contains("Male") || description.contains("Female")){
						description=description.replaceAll("Male", "%");
						description=description.replaceAll("Female", "%");
					}
				
					
					st1 = con1.createStatement();    
				    String sql1 = "SELECT total FROM demography WHERE descrip Like'"+description+"' ORDER BY ID DESC LIMIT 1";
