...
PreparedStatement pst = con.prepareStatement("insert into demography(date,descrip,currentx,previous,diff,total) values(?,?,?,?,?,?)");

pst.setString(1, date);
pst.setString(2, desc);
pst.setString(3, current);
pst.setString(4, prev);
pst.setString(5, diff);
                                        ...
                                        <div class="col-sm-12">
                                            <div class="card">
                                               ...
                                               <!-- ----------------------------- Calculated Values ----------------------------------------- --> 
                                                                      ...
                                                                      <div align="center"><h6 style="margin-top:15px">Demography/Discipleship</h6></div>
                                                                      <hr style="border: 1px solid orange; margin-bottom:0px;">
                                                                  ...
                                                                  <form method="post" action="#">
                                                                        <div class="form-group row  container justify-content-center" >
                                                                            <div class="col-sm-3">
                                                                             ...
                                                                             <div class="col-sm-6">
                                                                             <label>Description</label> <!-- Drop down with Check Boxes -->
                                                                             <div class="input-group">
                                                                             
                                                                                
																				<select class="form-control" name="desc" id="desc">
																	                           <option >Dedicated Children Membership (below 13yrs)Male</option>
																	                           <option >Dedicated Children Membership (below 13yrs)Female</option>
																	                           <option >Teenagers (13 to 19yrs) Male</option>
																	                           <option >Teenagers (13 to 19yrs) Female</option>
																	                           <option >Young Adults (20 to 35yrs) Male</option>
																	                           <option >Young Adults (20 to35yrs)Female</option>
																	                           <option >Youth Membership (13 to 35 yrs) Male </option>
																	                           <option >Youth Membership (13 to 35 yrs) Female</option>
																	                           <option >Other Adults (Above 35 yrs)Male</option>
																	                           <option >Other Adults (Above 35 yrs)Female</option>
																	                           <option >Hum</option>
                                                                        ...
                                                                        <div class="form-group row  container justify-content-center" >
                                                                           ...
                                                                           <div class="col-sm-3">
                                                                            <label>Previous</label>
                                                                                <input type="text" class="form-control" name="prev" id="prev" readonly>
                                                                            </div>
                                                                           
                                                                            <div class="col-sm-3">
                                                                            <label>Difference</label>
                                                                                <input type="text" class="form-control"
                                                                              name="diff" id="diff"readonly>
                                                                            </div>
                                                  ...
                                                  <div align="center">
                                                    <br>
                                                     ...
                                                     <button class="btn waves-effect waves-light btn-danger btn-outline-danger" type="reset"><i class="fa-solid fa-ban"></i>Cancel</button>
                                                                     ...
                                                                     <button class="btn waves-effect waves-light btn-primary btn-outline-primary" type="submit" onclick="calculate()" id="calculate"><i class="fa-regular fa-floppy-disk"></i>Calculate</button>
                                                               		  ...
                                                               		  <script>
																	          function calculate(){
																	        	  ...
																	        	  $.ajax({
																	        		  ...
																	        		  type:"POST",
																	        		  url:"calculateDemo.jsp",
																	        		  data:{"desc":$("#desc").val() ,"current":$("#current").val(),"chil":'chil'},
												                     ...
												                     <!-- ----------------------------- Calculated Values ----------------------------------------- --> 
                                                                      ...
                                                                      <hr style="border: 1px solid orange; margin-bottom:0px;">
                                                                      <div align="center"><h6 style="margin-top:15px">LIST OF ACTIVE SERVICES</h6></div>
                                                                      <hr style="border: 1px solid orange; margin-bottom:0px;">
                                              ...
                                              <div class="card-block table-border-style">
                                                <div class="table-responsive">
                                                    <table class="table table-hover">
                                                        ...
                                                        String sql ="select*from demography";
                                                         int i = 0;
