...
PreparedStatement pst = con.prepareStatement("insert into tithes(branch,month,date,amount) values(?,?,?,?)");
                                        ...
                                        <div class="col-sm-12">
                                            <div class="card">
                                               ...
                                               <!-- ----------------------------- Calculated Values ----------------------------------------- --> 
                                                                      ...
                                                                      <div align="center"><h6 style="margin-top:15px">Tithes</h6></div>
                                                                      <hr style="border: 1px solid orange; margin-bottom:0px;">
