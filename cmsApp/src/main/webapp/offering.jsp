...
Connection con = DriverManager.getConnection("jdbc:mysql://eu-cdbr-west-02.cleardb.net/heroku_8f9cc2f24b1594b?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC","b4526065f350ab","f8a08217");
                                        ...
                                        <div class="col-sm-12">
                                            <div class="card">
                                               ...
                                               <!-- ----------------------------- Calculated Values ----------------------------------------- --> 
                                                                      ...
                                                                      <div align="center"><h6 style="margin-top:15px">Offering</h6></div>
                                                                      <hr style="border: 1px solid orange; margin-bottom:0px;">
                                                                  ...
                                                                  <form method="post" action="#">
                                                                        <div class="form-group row  container justify-content-center" >
                                                                            <div class="col-sm-3">
                                                                             ...
                                                                             <div class="col-sm-6">
                                                                             <label>Type Of Offering</label> <!-- Drop down with Check Boxes -->
                                                                             <div class="input-group">
                                                                             
                                                                                
																				<select class="form-control" name="type" id="type">
																	                           <option >main harvest</option>
																	                           <option >food</option>
																	                           <option >for pastor</option>
																	                           <option >for expenses</option>
																	                           <option >for electricity</option>
