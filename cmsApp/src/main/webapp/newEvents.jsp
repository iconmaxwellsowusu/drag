...
PreparedStatement pst = con.prepareStatement("insert into event1(date,assembly,title,category,time,location) values(?,?,?,?,?,?)");
                                        ...
                                        <div class="col-sm-12">
                                            <div class="card">
                                               ...
                                               <!-- ----------------------------- Calculated Values ----------------------------------------- --> 
                                                                      ...
                                                                      <div align="center"><h6 style="margin-top:15px">Add Event</h6></div>
                                                                      <hr style="border: 1px solid orange; margin-bottom:0px;">
                                                                  ...
                                                                  <form method="post" action="#">
                                                                       ...
                                                                       <div class="form-group row  container justify-content-center" >
                                                                           ...
                                                                           <div class="col-sm-3">
                                                                             <label>Category</label> <!-- Drop down with Check Boxes -->
                                                                             <div class="input-group">
                                              ...
                                              <div class="card-block table-border-style">
                                                <div class="table-responsive">
                                                    <table class="table table-hover">
                                                        ...
                                                        String sql = "SELECT assembly, category,title,time,location,Date, FLOOR(TIMESTAMPDIFF(MINUTE, NOW(), Date) / 1440) as Days, FLOOR(TIMESTAMPDIFF(MINUTE, NOW(), Date) % 1440 / 60) as Hours, TIMESTAMPDIFF(MINUTE, NOW(), Date) % 60 as Minutes FROM event1 ";
                                                        int i = 0;
