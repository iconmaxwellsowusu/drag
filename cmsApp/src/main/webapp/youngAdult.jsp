...
String aqui=request.getParameter("aqui");
String indenture=request.getParameter("indenture");
String indentureC=request.getParameter("indentureC");
String docu=request.getParameter("docu");
String permit=request.getParameter("permit");
String where=request.getParameter("where");
String completed=request.getParameter("completed");
String completedB=request.getParameter("completedB");
String inpro=request.getParameter("inpro");
String noLand=request.getParameter("noLand");
String noFund=request.getParameter("noFund");
String landL=request.getParameter("landL");
...
String completedC=request.getParameter("completedC");
String uncompleted=request.getParameter("uncompleted");
...
String underTree=request.getParameter("underTree");
...
PreparedStatement pst = con.prepareStatement("insert into estate(date,aqui,indenture,indentureC,docu,permit,where1,completed,completedB,inpro,noLand,noFund,landL,others1,seating,permanent,completedC,uncompleted,temp,tempS,plot,hall,free,classRoom,underTree,others2,official) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");

pst.setString(1, date);
pst.setString(2, aqui);
pst.setString(3, indenture);
pst.setString(4, indentureC);
pst.setString(5, docu);
pst.setString(6, permit);
pst.setString(7, where);
pst.setString(8, completed);
pst.setString(9, completedB);
pst.setString(10, inpro);
pst.setString(11, noLand);
pst.setString(12, noFund);
pst.setString(13, landL);
pst.setString(14, others1);
pst.setString(15, seating);
pst.setString(16, permanent);
pst.setString(17, completedC);
pst.setString(18, uncompleted);
pst.setString(19, temp);
pst.setString(20, tempS);
pst.setString(21, plot);
pst.setString(22, hall);
pst.setString(23, free);
pst.setString(24, classRoom);
pst.setString(25, underTree);
pst.setString(26, others2);
pst.setString(27, official);
                                        ...
                                        <div class="col-sm-12">
                                            <div class="card">
                                               ...
                                               <!-- ----------------------------- Calculated Values ----------------------------------------- --> 
                                                                      ...
                                                                      <div align="center"><h6 style="margin-top:15px">Estate (Church Buildings)</h6></div>
                                                                      <hr style="border: 1px solid orange; margin-bottom:0px;">
                                                                  ...
                                                                  <form method="post" action="#">
                                                                        <div class="form-group row  container justify-content-center" >
                                                                          ...
                                                                          <div class="col-sm-3">
                                                                            <label>Official Payment Receipts / Allocation Paper</label>
                                                                                <input type="checkbox" class="form-control" name="official" value="[&#10004;]">
                                                                            </div>
                                                                            
                                                                            <div class="col-sm-3">
                                                                            <label>Acquisition of Site Plan </label>
                                                                                <input type="checkbox" class="form-control" name="aqui" value="[&#10004;]">
                                                                            </div>
                                                                            
                                                                            <div class="col-sm-3">
                                                                            <label>Indenture in progress duly signed </label>
                                                                                <input type="checkbox" class="form-control" name="indenture" value="[&#10004;]">
                                                                            </div>
                                                                        ...
                                                                        <div class="form-group row  container justify-content-center" >
                                                                           ...
                                                                           <div class="col-sm-3">
                                                                            <label>Indenture Completed</label>
                                                                                <input type="checkbox" class="form-control" name="indentureC" value="[&#10004;]" >
                                                                            </div>
                                                                           
                                                                           <div class="col-sm-3">
                                                                            <label>Title Deed / Full Documentation    </label>
                                                                                <input type="checkbox" class="form-control" name="docu" value="[&#10004;]">
                                                                            </div>
                                                                           
                                                                            <div class="col-sm-3">
                                                                            <label>Permit Acquired for Church Buildings  </label>
                                                                                <input type="checkbox" class="form-control"
                                                                              name="permit" value="[&#10004;]">
                                                                            </div>
                                                                            
                                                                            <div class="col-sm-3">
                                                                            <label>Where is/are the document(s) lodged?</label>
                                                                                <input type="text" class="form-control"
                                                                              name="where" id="diff">
                                                                            </div> 
                                                                      ...
                                                                      <hr style="border: 1px solid orange; margin-bottom:0px;">
                                                                      <div align="center"><h6 style="margin-top:15px">Permanent Church Building (tick one as applicable)</h6></div>
                                                                      <hr style="border: 1px solid orange; margin-bottom:0px;">
                                                                        
                                                                       <div class="form-group row  container justify-content-center" >
                                                                       
                                                                        <div class="col-sm-3">
                                                                            <label>Completed and dedicated </label>
                                                                                <input type="checkbox" class="form-control"
                                                                              name="completed" id="total" >
                                                                            </div>
                                                                           
                                                                           <div class="col-sm-3">
                                                                            <label>Completed but not dedicated</label>
                                                                                <input type="checkbox" class="form-control" name="completedB" value="[&#10004;]">
                                                                            </div>
                                                                            
                                                                            <div class="col-sm-3">
                                                                            <label>In-Progress</label>
                                                                                <input type="checkbox" class="form-control" name="inpro" value="[&#10004;]" >
                                                                            </div>
                                                                            
                                                                        </div>
                                                                        
                                                                        <hr style="border: 1px solid orange; margin-bottom:0px;">
                                                                      <div align="center"><h6 style="margin-top:15px">Not started because:</h6></div>
                                                                      <hr style="border: 1px solid orange; margin-bottom:0px;">
                                                                         ...
                                                                         <div class="form-group row  container justify-content-center" >
                                                                            ...
                                                                            <label>No Land</label>
                                                                             ...
                                                                             <div class="col-sm-3">
                                                                            <label>No Funds</label>
                                                                                <input type="checkbox" class="form-control"
                                                                              name="noFund" value="[&#10004;]" >
                                                                            </div>
                                                                           
                                                                           <div class="col-sm-3">
                                                                            <label>Land Litigation</label>
                                                                                <input type="checkbox" class="form-control" name="landL" value="[&#10004;]" >
                                                                            </div>
                                                                           
                                                                           <div class="col-sm-3">
                                                                            <label>Others (specify) </label>
                                                                                <input type="text" class="form-control" name="others1" id="prev" >
                                                                            </div>
                                                                           
                                                                            <div class="col-sm-3">
                                                                            <label>Seating Capacity of Permanent Church Building </label>
                                                                                <input type="text" class="form-control"
                                                                              name="seating" id="diff">
                                                                            </div>
                                                                            
                                                                             <div class="col-sm-3">
                                                                            <label>Permanent Church Building has accessible ramp(s) for persons with disabilities </label>
                                                                                <input type="checkbox" class="form-control"
                                                                      ...
                                                                      <hr style="border: 1px solid orange; margin-bottom:0px;">
                                                                      <div align="center"><h6 style="margin-top:15px">62.	Current Place of Worship (tick)</h6></div>
                                                                      <hr style="border: 1px solid orange; margin-bottom:0px;">
                                                                        
                                                                      <div class="form-group row  container justify-content-center" >
                                                                           
                                                                           <div class="col-sm-3">
                                                                            <label>Completed Permanent Church Building </label>
                                                                                <input type="checkbox" class="form-control" name="completedC" value="[&#10004;]">
                                                                            </div>
                                                                           
                                                                           <div class="col-sm-3">
                                                                            <label>Uncompleted Permanent Church Building </label>
                                                                                <input type="checkbox" class="form-control" name="uncompleted" value="[&#10004;]" >
                                                                            </div>
                                                                           
                                                                            <div class="col-sm-3">
                                                                            <label>Temporary Structure on Church Plots </label>
                                                                                <input type="checkbox" class="form-control"
                                                                              name="temp" value="[&#10004;]">
                                                                            </div>
                                                                            
                                                                             <div class="col-sm-3">
                                                                            <label>Temporary Structure on Rented Plots</label>
                                                                                <input type="checkbox" class="form-control"
                                                                              name="tempS" value="[&#10004;]">
                                                                            </div>
                                                                         ...
                                                                         <div class="form-group row  container justify-content-center" >
                                                                           ...
                                                                           <div class="col-sm-3">
                                                                            <label>Rented Hall</label>
                                                                                <input type="checkbox" class="form-control" name="hall" value="[&#10004;]" >
                                                                            </div>
                                                                           
                                                                           <div class="col-sm-3">
                                                                            <label>Free Accommodation</label>
                                                                                <input type="checkbox" class="form-control" name="free" value="[&#10004;]" >
                                                                            </div>
                                                                           
                                                                            <div class="col-sm-3">
                                                                            <label>School Classroom</label>
                                                                                <input type="checkbox" class="form-control"
                                                                              name="classRoom" value="[&#10004;]">
                                                                            </div>
                                                                            
                                                                             <div class="col-sm-3">
                                                                            <label>Under Trees </label>
                                                                                <input type="checkbox" class="form-control"
                                                                              name="underTree" value="[&#10004;]" >
                                                                            </div>
                                                                       ...
                                                                       <div class="form-group row  container justify-content-center" >
                                                                           ...
                                                                           <div class="col-sm-3">
                                                                            <label>Others (specify)   </label>
                                                                                <input type="text" class="form-control" name="others2" id="prev" >
                                                                            </div>
                                                    ...
                                                    <br>
                                                     ...
                                                     <button class="btn waves-effect waves-light btn-danger btn-outline-danger" type="reset"><i class="fa-solid fa-ban"></i>Cancel</button>
												                     ...
												                     <!-- ----------------------------- Calculated Values ----------------------------------------- --> 
                                                                      ...
                                                                      <hr style="border: 1px solid orange; margin-bottom:0px;">
                                                                      <div align="center"><h6 style="margin-top:15px">PART TWO: Estate (Church Buildings)</h6></div>
                                                                      <hr style="border: 1px solid orange; margin-bottom:0px;">
                                                    ...
                                                    <table class="table table-hover">
                                                        <thead>
                                                            <tr>
                                                                <th>#</th>
                                                                <th>Date</th>
                                                                <th>document(s) lodged</th>
                                                                <th>Seating Capacity of Permanent Church Building </th>
                                                        ...
                                                        <td><%=rs.getString("where1") %></td>
                                                        <td><%=rs.getString("seating") %></td>
                                                         ...
                                                         <td>
                                                                ...
                                                                <a href="vForm.jsp?id=<%=rs.getString("ID")%>"> <button title="Veiw"><i class="ti-eye" style="color:green; cursor:pointer; padding:5px;"></i></button></a>
