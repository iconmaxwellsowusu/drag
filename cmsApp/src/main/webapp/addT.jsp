...
if(request.getParameter("add")!=null){
    ...
    if (select != null && select.length != 0) {
        for (int i = 0; i < select.length; i++) {
            ...
            pst = con.prepareStatement("insert into attendance(name,adress,phone) select name,res,mobile from copform where id = '"+select[i]+"'");
            pst.executeUpdate();    
    ...
    String sql = "select date,assembly,service,ses from service where ID='"+serviceId+"'";
    ...
    String sql1 = "select id from attendance where date is null";
    rs=st.executeQuery(sql1);
    while(rs.next()){
    	String test = rs.getString("id");
    	PreparedStatement pst1 = con.prepareStatement("update attendance set date=?,assembly=?,service=?,ses=? where ID=?");
    	pst1.setString(1, date);
    	pst1.setString(2, assembly);
    	pst1.setString(3, service);
    	pst1.setString(4, ses);
    	pst1.setString(5, test);
										 ...
										 <div class="card-block table-border-style">
                                                ...
                                                <form method="post" action="#">
                                                    <table class="table table-hover">
                                                        ...
                                                        Class.forName("com.mysql.jdbc.Driver");
                                                        Connection con1=DriverManager.getConnection("jdbc:mysql://localhost/cop","root","root");
                                                        ...
                                                        %>
                                                            <tr>
                                                               <td class="align-middle text-center"> <input type="checkbox" name="list" value="<%=rs1.getString("id")%>"></td>
                                                    ...
                                                    <button class="btn btn-primary" name="add">Add Selected Members to service</button>
