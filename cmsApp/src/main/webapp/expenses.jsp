...
PreparedStatement pst = con.prepareStatement("insert into expenses(branch,month,date,type1,expense,amount,dAmount) values(?,?,?,?,?,?,'0.00')");

if(type.equals("Deposit")){
	expense="Deposit";
    pst = con.prepareStatement("insert into expenses(branch,month,date,type1,expense,amount,dAmount) values(?,?,?,?,?,'0.00',?)");
}
                                                                  ...
                                                                  <form method="post" action="#">
                                                                        <div class="form-group row  container justify-content-center" >
                                                                            <div class="col-sm-3">
                                                                             ...
                                                                             <div class="col-sm-3">
                                                                             <label>type</label> <!-- Drop down with Check Boxes -->
                                                                             <div class="input-group">
                                                                              ...
                                                                              <div class="col-sm-3">
                                                                             <label>Expense for</label> <!-- Drop down with Check Boxes -->
                                                                             <div class="input-group">
                                                                          ...
                                                                          <div class="col-sm-3">
                                                                            <label>Amount deposited/spended</label>
                                              ...
                                              <div class="card-block table-border-style">
                                                <div class="table-responsive">
                                                    <table class="table table-hover">
                                                        ...
                                                        double dep= rs.getDouble("dAmount");
                                                        totaldeposit+=dep;
                                                        
                                                        double exp = rs.getDouble("amount");
                                                        totalex +=exp;
                                                        
                                                        bal=totaldeposit-totalex;
                                                        out.println(bal);
                                                        %></td>
