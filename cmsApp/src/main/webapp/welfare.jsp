...
PreparedStatement pst = con.prepareStatement("insert into welfare(branch,month,date,type1,member1,amount) values(?,?,?,?,?,?)");
                                        ...
                                        <div class="col-sm-12">
                                            <div class="card">
                                               ...
                                               <!-- ----------------------------- Calculated Values ----------------------------------------- --> 
                                                                      ...
                                                                      <div align="center"><h6 style="margin-top:15px">Membership Welfare</h6></div>
                                                                      <hr style="border: 1px solid orange; margin-bottom:0px;">
                                                                  ...
                                                                  <form method="post" action="#">
                                                                        <div class="form-group row  container justify-content-center" >
                                                                            <div class="col-sm-3">
                                                                             ...
                                                                             <div class="col-sm-3">
                                                                             <label>Welfare Type</label> <!-- Drop down with Check Boxes -->
                                                                             <div class="input-group">
                                                                             
                                                                                
																				<select class="form-control" name="type" id="type">
																	                           <option >Funeral Welfare</option>
																	                           <option >Scholarship Welfare</option>
                                                                            ...
                                                                            <div class="col-sm-3">
                                                                             <label>Member Name</label> <!-- Drop down with Check Boxes -->
                                                                             <div class="input-group">
                                              ...
                                              <div class="card-block table-border-style">
                                                <div class="table-responsive">
                                                    <table class="table table-hover">
                                                        ...
                                                        String sql1 ="select *,sum(welfare.amount) over (partition by type1 order by welfare.id) as test from welfare";
                                                         int i = 0;
                                                        double total=0;
