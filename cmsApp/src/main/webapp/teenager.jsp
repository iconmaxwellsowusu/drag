...
PreparedStatement pst = con.prepareStatement("insert into minitries(date,descrip,currentx,previous,diff,total) values(?,?,?,?,?,?)");
                                                                            ...
                                                                            <div class="col-sm-3">
                                                                             ...
                                                                             <div class="input-group">
																				...
																				<select class="form-control" name="desc" id="desc">
																	                           <option >No. of Classes Held Men</option>
																	                           <option >No. of Classes Held Women</option>
																	                           <option >No. of Classes Held youth</option>
																	                           <option >No. of Classes Held Evangelism</option>
																	                           <option >No. of Classes Held Children</option>
																	                           <option >No. of activities held HUM </option>
																	                           <option >No. of activities held MPWDs </option>
																	                           <option >No. of converts Rehabilitated HUM </option>
																	                           <option >No. of converts Rehabilitated MPWDs</option>
																	                           <option >No of persons with disabilities </option>
                                                    ...
                                                    <br>
                                                     ...
                                                     <button class="btn waves-effect waves-light btn-danger btn-outline-danger" type="reset"><i class="fa-solid fa-ban"></i>Cancel</button>
                                                               		  ...
                                                               		  <script>
																	          function calculate(){
																	        	  ...
																	        	  $.ajax({
																	        		  ...
																	        		  data:{"desc":$("#desc").val() ,"current":$("#current").val(),"minis":'minis'},
												                     ...
												                     <!-- ----------------------------- Calculated Values ----------------------------------------- --> 
                                                                      ...
                                                                      <hr style="border: 1px solid orange; margin-bottom:0px;">
                                                                      <div align="center"><h6 style="margin-top:15px">MINISTRIES</h6></div>
                                                                      <hr style="border: 1px solid orange; margin-bottom:0px;">
                                              ...
                                              <div class="card-block table-border-style">
                                                <div class="table-responsive">
                                                    <table class="table table-hover">
                                                        ...
                                                        String sql ="select*from minitries";
                                                         int i = 0;
