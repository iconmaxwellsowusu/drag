...
PreparedStatement pst = con.prepareStatement("insert into pledge(branch,month,date,member1,type1,amount,amountR,dateR) values(?,?,?,?,?,?,?,?)");
...
pst.setString(7, amountR);
pst.setString(8, dateR);
                                        ...
                                        <div class="col-sm-12">
                                            <div class="card">
                                               ...
                                               <!-- ----------------------------- Calculated Values ----------------------------------------- --> 
                                                                      ...
                                                                      <div align="center"><h6 style="margin-top:15px">ADD A PLEDGE</h6></div>
                                                                      <hr style="border: 1px solid orange; margin-bottom:0px;">
                                                                  ...
                                                                  <form method="post" action="#">
                                                                        <div class="form-group row  container justify-content-center" >
                                                                           ...
                                                                           <div class="col-sm-3">
                                                                             <label>Select Pledger</label> <!-- Drop down with Check Boxes -->
                                                                             <div class="input-group">
																				...
																				<%
																				  ...
																				  String sql = "select * from copForm";
                                                                             ...
                                                                             <div class="input-group">
																				...
																				<select class="form-control" name="type" id="type">
																	                           <option >Pledge For Buying car</option>
																	                           <option >Pledge For building</option>
																	                           <option >Pledge Maintenance</option>
                                                                          ...
                                                                          <div class="col-sm-3">
                                                                            <label>Amount Pledged For</label>
                                                                        ...
                                                                        <div class="form-group row  container justify-content-center" >
                                                                           ...
                                                                           <div class="col-sm-3">
                                                                            <label>Amount Paid</label>
                                                                                <input type="text" class="form-control" name="amountR" id="amountR" >
                                                                            </div>
                                                    ...
                                                    <br>
                                                     ...
                                                     <button class="btn waves-effect waves-light btn-danger btn-outline-danger" type="reset"><i class="fa-solid fa-ban"></i>Cancel</button>
												                     ...
												                     <!-- ----------------------------- Calculated Values ----------------------------------------- --> 
                                                                      ...
                                                                      <hr style="border: 1px solid orange; margin-bottom:0px;">
                                                                      <div align="center"><h6 style="margin-top:15px">LIST OF PLEDGES</h6></div>
                                                                      <hr style="border: 1px solid orange; margin-bottom:0px;">
                                              ...
                                              <div class="card-block table-border-style">
                                                <div class="table-responsive">
                                                    <table class="table table-hover">
                                                        ...
                                                        String sql1 ="select *,sum(pledge.amount-pledge.amountR) over (partition by member1 order by pledge.id) as test from pledge";
                                                         int i = 0;
                                                        ...
                                                        <td data-toggle="modal" data-target="#maritalModal" title="add title" style="cursor:pointer; color:blue"><%=rs.getString("member1") %></td>
                                                        <td><%=rs.getString("type1") %></td>
                                                        <td><%=rs.getString("amount") %></td>
                                                        <td><%=rs.getString("amountR") %></td>
