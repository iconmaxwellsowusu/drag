                                        ...
                                        <div class="col-sm-12">
                                            <div class="card">
                                               ...
                                               <!-- ----------------------------- Calculated Values ----------------------------------------- --> 
                                                                 ...
                                                                 String sql="select * from estate where ID= '"+id+"'";
                                                                        ...
                                                                        <div class="form-group row  container justify-content-center" >
                                                                            <div class="col-sm-3">
                                                                               <label>Select Date</label>
                                                                                <input type="Date" class="form-control" name="date" id="date" value="<%=rs.getString("date") %>">
                                                                            </div>
                                                                            
                                                                            
                                                                          <div class="col-sm-3">
                                                                            <label>Official Payment Receipts / Allocation Paper</label>
                                                                               <h5> <%out.println(rs.getString("official")); %></h5>
                                                                            </div>
                                                                            
                                                                            <div class="col-sm-3">
                                                                            <label>Acquisition of Site Plan </label>
                                                                                <h5><%=rs.getString("aqui") %></h5>
                                                                            </div>
                                                                            
                                                                            <div class="col-sm-3">
                                                                            <label>Indenture in progress duly signed </label>
                                                                               <h5> <%=rs.getString("indenture") %></h5>
                                                                            </div>
                                                                       ...
                                                                       <div class="form-group row  container justify-content-center" >
                                                                        ...
                                                                        <div class="col-sm-3">
                                                                            <label>Completed and dedicated </label>
                                                                                <h5><%=rs.getString("completed") %></h5>
                                                                            </div>
                                                                           
                                                                           <div class="col-sm-3">
                                                                            <label>Completed but not dedicated</label>
                                                                                <h5><%=rs.getString("completedB") %></h5>
                                                                            </div>
                                                                            
                                                                            <div class="col-sm-3">
                                                                            <label>In-Progress</label>
                                                                                <h5><%=rs.getString("inpro") %></h5>
                                                                            </div>
                                                                         ...
                                                                         <div class="form-group row  container justify-content-center" >
                                                                           ...
                                                                           <div class="col-sm-3">
                                                                            <label>Rented Hall</label>
                                                                               <h5> <%=rs.getString("hall") %></h5>
                                                                            </div>
                                                                           
                                                                           <div class="col-sm-3">
                                                                            <label>Free Accommodation</label>
                                                                              <h5><%=rs.getString("free") %></h5>
                                                                            </div>
                                                                           
                                                                            <div class="col-sm-3">
                                                                            <label>School Classroom</label>
                                                                               <h5><%=rs.getString("classRoom") %></h5>
                                                                            </div>
                                                                            
                                                                             <div class="col-sm-3">
                                                                            <label>Under Trees </label>
                                                                                <h5><%=rs.getString("underTree") %></h5>
                                                                            </div>
